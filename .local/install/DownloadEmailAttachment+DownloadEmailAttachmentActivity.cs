...
namespace RPATask
{
    ...
    public class DownloadEmailAttachmentActivity : System.Activities.Activity
    {
        public DownloadEmailAttachmentActivity()
        {
            this.Implementation = () =>
            {
                return new DownloadEmailAttachmentActivityChild()
                {};
            };
        }
    }

    internal class DownloadEmailAttachmentActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public DownloadEmailAttachmentActivityChild()
        {
            DisplayName = "DownloadEmailAttachment";
        }
        ...
        {
            var codedWorkflow = new global::RPATask.DownloadEmailAttachment();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "DownloadEmailAttachment.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "DownloadEmailAttachment.cs", Exception = exception});
                }
